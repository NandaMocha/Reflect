...
3. **Owner moderation** — the space owner can **remove a member** (via the standard
   CloudKit sharing controller's participant management, reachable any time from the
   space's **Members** screen → *Invite People*) and **delete the entire space**
...
2. Create a space, **Ask for Feedback** (a request), then give **feedback** on it.
   Tap the **Members** (person.2) toolbar button to see who's in the space and, as owner,
